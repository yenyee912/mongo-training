const CourseModel = require("./courseModel") //Schema
...
exports.getAllCourse = async (req, res) => {
  ...
  const x = await CourseModel.find().sort({ _id: 1 })
  // find: find all 
...
//   const oneStudent = await CourseModel.findOne({ name: req.params.name }, returningField)
